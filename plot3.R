...
plot(DateAndTime, subMetering1, type="l", ylab="Energy Submetering", xlab="")  ## generates the plot and subMetering1 line stays back as default 
lines(DateAndTime, subMetering2, type="l", col="red")                          ## assigns red color to subMetering2 line 
lines(DateAndTime, subMetering3, type="l", col="blue")						   ## assigns blue color to subMetering3 line 
